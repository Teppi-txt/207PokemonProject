...
public class Move implements Serializable {
    ...
    // int or null (for status)
    private Integer accuracy;
    // percentage of a successful hit
    private Integer priority;
    // higher priority moves first
    private String effect;
    // I'm not sure if we are using this but I see them in the api
    private int effect_chance;
    // Percentage chance that the move's additional effect occurs
    private String short_effect;
    // the move's additional effect, usually excluding damage info
    private int pp;
    // Power Points: the number of times this move can be used in battle.
    ...
    public Move setDamageClass(String damageClass) {
    ...
    public Move setPower(Integer power) {
        this.power = power;
        return this;
    }
    ...
    public Move setAccuracy(Integer accuracy) {
    ...
    public Move setEffect(String effect) {
        this.effect = effect;
        return this;
    }
    ...
    public Move setEffect_chance(int effect_chance) {
    ...
    public Move setShortEffect(String short_effect) {
